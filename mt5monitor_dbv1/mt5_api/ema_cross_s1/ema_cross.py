...
class EMA:
    ...
    def __init__(self):
        ...
        self.db_connection = self.db_conn_cls_obj.get_connection(
            schema_name='schema_ema_monitor_30m', from_func=self.__module__)
    ...
    def __write_result_for_notification__(self, symbol, result, time_frame, signal_name,
        ...
        if config['execute_trade'] is True:
            ...
            for index, row in result.iterrows():
                ...
                execute_trade_resp = execute_trade_wrapper(symbol=row['symbol'],
                                                           signal=row['signal'],
        ...
        if df_rates is not None:
            ...
            if signal is not None:
                ...
                if signal_strength.strength == 'WEEK' and strat_id == 1:
                    ...
                    possible_sl = find_stop_loss(config['lookback_stop_loss'], df_rates,
                                                 signal_strength_obj.ema_model.signal)
